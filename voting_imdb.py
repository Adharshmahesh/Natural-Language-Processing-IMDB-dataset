...
estimators=[('LinearSVC', svc_clf), ('Logistic_Regression', lr)]
ensemble = VotingClassifier(estimators, voting='hard')
start = time.time()
#Fitting the model on traininf data
ensemble.fit(Xtrain, ytrain)
ypred_val_en   = ensemble.predict(Xtest)
...
confusion_matrix(ypred_val_en, ytest)
